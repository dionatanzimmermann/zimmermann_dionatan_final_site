...
describe('HeroImage', () => {
  test('renders the hero image with headline', () => {
    render(<HeroImage imageUrl="heroimage.png" headline="Test Headline" subheadline="Subhead" />);
    expect(screen.getByRole('img')).toBeVisible();
    expect(screen.getByText('Test Headline')).toBeInTheDocument();
  });

  test('applies disabled style when disabled is true', () => {
    render(<HeroImage imageUrl="heroimage.png" headline="Test" subheadline="Test sub" disabled />);
